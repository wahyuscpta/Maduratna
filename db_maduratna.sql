...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 17, 2024 at 03:35 AM
...
INSERT INTO `tb_service` (`id_service`, `nama`, `harga`, `desc_service`) VALUES
(1, 'Man Haircut', '50K', 'Layanan perawatan sederhana dan cepat namun berkualitas tinggi yang memberikan potongan rambut paling menarik, diikuti dengan pijat kepala dan punggung dan pemberian pomade.'),
(2, 'Hair Coloring', '80K', 'Anda menginginkannya, kami membuatnya. Biarkan tukang cukur berpengalaman kami mewarnai rambut Anda dengan sempurna sesuai keinginan.'),
(3, 'Beard Shaving', '75K', 'Dimulai dengan handuk panas untuk merilekskan kulit Anda dan membuka pori-pori Anda, diikuti dengan pencukuran yang cermat dan nyaman.'),
(4, 'Hair Grooming', '100K', 'Layanan perawatan pria penuh. Dimulai dengan handuk dingin, lalu potong dan cuci rambut, dilanjutkan dengan pijat kepala dan punggung dengan handuk panas, diakhiri dengan pengaplikasian hair tonic dan pomade berkualitas tinggi.');
