                ...
                <nav class="navbar navbar-expand-lg navbar-light bg-light">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                        <div class="navbar-nav">
                            ...
                            <a class="nav-item nav-link active" href="view.php">Testimoni</a>
                ...
                <div class="col-12">
                    <div class="bg-content">
                        ...
                        <div class="table-responsive">
                            ...
                            <h6 class="text-center">NO Testimoni</h6>
                            ...
                            <table class="table table-hover table-bordered">
                                ...
                                <tbody align="center">
                                    ...
                                    <td><input type="text" value="<?=$sql['testimoni']?>" name="pesan" class="text-center"></td>
                                    <td><a onclick="return confirm('Yakin Ingin Menghapus Data Ini ?')" href="process/delete.php?id=<?=$sql['id_pesan']?>" class="btn btn-danger btn-sm">DELETE</a></td>
                                </tbody>
