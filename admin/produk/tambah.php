                ...
                <div class="col-12">
                    <div class="bg-content edit">
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-4">
                                <div class="form-group">
                                    <input type="text" name="fitur_1" class="form-control" placeholder="Features - 1 ">
                                </div>
                            </div>

                            <div class="col-4">
                                <div class="form-group">
                                    <input type="text" name="fitur_2" class="form-control" placeholder="Features - 2">
                                </div>
                            </div>

                            <div class="col-4">
                                <div class="form-group">
                                    <input type="text" name="fitur_3" class="form-control" placeholder="Features - 3">
                                </div>
                            </div>      

                            <div class="col-12">
                                <div class="form-group">
                                    <textarea name="desc" placeholder="Desc Produk" cols="30" rows="10" class="form-control"></textarea>
                                </div>
                            </div>                            
