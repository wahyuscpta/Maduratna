      ...
      <nav class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="">DAFTAR STAFF</a>
          </div>
                  ...
                  <table class="table">
                    ...
                    <table class="table table-hover table-bordered">
                        ...
                        <tbody align="center">
                            ...
                            <td><a href="edit.php?id=<?=$sql['id_staff']?>" class="btn btn-success btn-sm mt-1">EDIT</a>
                                <a onclick="return confirm('Yakin Ingin Menghapus Data Ini ?')" href="process/delete.php?id=<?=$sql['id_staff']?>" class="btn btn-danger btn-sm mt-1">DELETE</a>
                            </td>
                        </tbody>
                    ...
                    <form action="process/tambah-process.php" method="POST" enctype="multipart/form-data">
                      ...
                      <div class="row">
                        <div class="col-md-12 mb-3">
                            ...
                            <input type="file" name="gambar" class="form-control" placeholder="Foto Staff">
                        </div>
                      </div>
