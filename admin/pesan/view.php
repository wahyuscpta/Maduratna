                    ...
                    <table class="table table-hover table-bordered">
                        ...
                        <tbody align="center">
                          <form action="process/reply-process.php" method="POST">
                            <td><?= $i++; ?></td>
                            <td><input type="text" name="nama" value="<?= $sql['nama'] ?>"></td>
                            <td><input type="text" name="email" value="<?= $sql['email'] ?>"></td>
                            <td><input type="text" name="pesan" value="<?= $sql['pesan'] ?>"></td>
                            <td><button type="submit" class="btn btn-success btn-sm">TESTIMONI</button>
                                <a onclick="return confirm('Yakin Ingin Menghapus Data Ini ?')" href="process/delete.php?id=<?=$sql['id_pesan']?>" class="btn btn-danger btn-sm">DELETE</a>
                            </td>
                          </form>
                        </tbody>
