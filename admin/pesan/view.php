                ...
                <nav class="navbar navbar-expand-lg navbar-light bg-light">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                        <div class="navbar-nav">
                            ...
                            <a class="nav-item nav-link active" href="view.php">Pesan</a>
                    ...
                    <div class="bg-content">
                        ...
                        <div class="table-responsive">
                            ...
                            <table class="table table-hover table-bordered">
                                ...
                                <tbody align="center">
                                    <td><?=$i ?></td>
                                    <td><input type="text" value="<?=$sql['nama']?>" name="nama" class="text-center"></td>
                                    <td><input type="text" value="<?=$sql['email']?>" name="email" class="text-center"></td>
                                    <td><input type="text" value="<?=$sql['pesan']?>" name="pesan" class="text-center"></td>
                                    <td><button type="submit" class="btn btn-primary btn-sm">REPLY</button>
                                        <a onclick="return confirm('Yakin Ingin Menghapus Data Ini ?')" href="process/delete.php?id=<?=$sql['id_pesan']?>" class="btn btn-danger btn-sm">DELETE</a></td>
                                </tbody>
