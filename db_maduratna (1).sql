...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 04 Mar 2021 pada 01.18
...
('MDR001', 'Wahyu Sucipta', '089635208686', 'admin@gmial.com', '2021-03-04', 10, 1);
...
(2, 'Bocil', 'wahyuscpta13@gmail.com', 'Goblok Anjing'),
...
(1, 'John Alexander', 'Professional Barber', 'Jangan ragu untuk datang kepada saya. Dengan pengalaman dan skill yang saya miliki tentunya menjadi jaminan bahwa anda akan puas melihat hasillnya. So, tunggu apa lagi saya tunggu kedatangan anda di Maduratna Barbershop.', '1.jpg'),
(3, 'Steffan Julle', 'Professional Barber', 'Passion saya adalah mencukur. Seni saya adalah mencukur. Jadi anda tidak salah datang kepada saya karena tidak akan membiarkan customer kecewa. Percayakan kepada kami untuk semua permasalahan rambut anda.', '2.jpg'),
(4, 'Alexunder Bryan', 'Professional Barber', 'Sangat bangga bisa bergabung dengan Team Maduratna Barber Shop. Menurut saya memotong rambut adalah seni dan kanvas saya adalah rambut customer. Jadi saya siap memberikan pelayanan yang terbaik untuk kepuasan anda.', '3.jpg');
...
(13, 'Peter Jamerson', 'peterjemerson@gmail.com', 'Cocok Guntingannya, saya sudah menjadi pelanggan sejak Maduratna Barber Shop pertama kali buka. Tinggal datang, duduk, pulang. Sangat menyenangkan potong rambut disini.');
...
--
ALTER TABLE `tb_testimoni`
  MODIFY `id_testi` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
...
--
ALTER TABLE `tb_appoinment`
  ADD CONSTRAINT `tb_appoinment_ibfk_1` FOREIGN KEY (`id_jam`) REFERENCES `tb_jam` (`id_jam`),
  ADD CONSTRAINT `tb_appoinment_ibfk_2` FOREIGN KEY (`id_service`) REFERENCES `tb_service` (`id_service`);
COMMIT;
